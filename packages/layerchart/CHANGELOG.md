...
- breaking: Use camelCase (`aboveMarks`, etc) instead of kebob case (`above-marks`)` to fix Svelte 5 {#snippet} compatibility ([#269](https://github.com/techniq/layerchart/pull/269))
