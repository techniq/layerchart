...
- feat: Refine display of axis rule to use `0` for value axis ([#248](https://github.com/techniq/layerchart/pull/248))

- feat(Legend): Add `orientation` prop ([#248](https://github.com/techniq/layerchart/pull/248))

- feat(Axis): Support passing `class` and add `classes` support for root/label ([#248](https://github.com/techniq/layerchart/pull/248))
