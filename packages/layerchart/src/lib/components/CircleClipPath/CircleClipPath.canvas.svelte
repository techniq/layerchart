<script lang="ts" module>
  export type { CircleClipPathPropsWithoutHTML } from './CircleClipPath.shared.svelte.js';
</script>
...
<script lang="ts">
  ...
  let props: CircleClipPathPropsWithoutHTML = $props();
</script>

<CircleClipPathBase {ClipPath} {...props} />
