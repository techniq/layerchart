...
import type Arc from '../Arc/Arc.svelte';
import type Bars from '../Bars/Bars.svelte';
...
import type Labels from '../Labels/Labels.svelte';
import type Legend from '../Legend.svelte';
import type Line from '../Line/Line.svelte';
import type Pie from '../Pie/Pie.svelte';
import type Points from '../Points/Points.svelte';
