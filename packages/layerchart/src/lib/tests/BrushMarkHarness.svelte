<script lang="ts">
  ...
  import Brush from '$lib/components/Brush/Brush.svelte';
...
<Chart {data} x="date" y="value" width={400} height={200} {...chartProps}>
  <Layer type={layer}>
    <Brush bind:state {...brushProps} />
  </Layer>
</Chart>
