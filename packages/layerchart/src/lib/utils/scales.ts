...
export function isScaleBand(scale: any) {
 ...
 */
export function tweenedScale(scale: any, tweenedOptions: Parameters<typeof tweened>[1] = {}) {
  ...
  return {
    ...
    domain: (values: any[]) => tweenedDomain.set(values),
    range: (values: any[]) => tweenedRange.set(values),
  };
}
 ...
 */
export function springScale(scale: any, springOptions: Parameters<typeof spring>[1] = {}) {
  ...
  return {
    subscribe: tweenedScale.subscribe,
    domain: (values: any[]) => domainStore.set(values),
    range: (values: any[]) => rangeStore.set(values),
  };
}
 ...
 */
export function motionScale(scale: any, options: MotionOptions) {
