...
| Selecting across facets   | `context.brush.contains()` with `fx` / `fy`              | [facet-brush](/docs/components/Chart/facet-brush)                             |
| Selection on other scales | `group.brush.contains()` in a `ChartGroup`               | [facet-brush-summary](/docs/components/Chart/facet-brush-summary)             |
