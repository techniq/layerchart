	...
	{#snippet tooltip()}
		<Tooltip.Root>
			{#snippet children({ data })}
				<Tooltip.Header>{data.island} — {data.species}</Tooltip.Header>
				<Tooltip.List>
					<Tooltip.Item label="Penguins" value={data.value} format="integer" />
				</Tooltip.List>
			{/snippet}
		</Tooltip.Root>
	{/snippet}
