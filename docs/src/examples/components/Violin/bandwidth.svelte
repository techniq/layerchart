	...
	const data = [
		{
			group: 'Tight',
			values: [
				28, 29, 30, 30, 30, 31, 31, 31, 32, 32, 32, 32, 33, 33, 33, 33, 33, 34, 34, 34, 34, 35,
				35, 35, 36, 36, 37, 38
			]
		},
		{
			group: 'Normal',
			values: [
				10, 15, 18, 20, 22, 25, 28, 30, 32, 35, 37, 40, 42, 45, 48, 50, 55, 58, 60, 62, 65, 68,
				70, 75, 78, 80, 85, 90
			]
		},
		{
		...
		},
		{
			group: 'Skewed',
			values: [
				5, 5, 8, 8, 10, 10, 10, 12, 12, 15, 15, 15, 18, 18, 20, 22, 25, 28, 30, 35, 40, 45, 55,
				65, 75, 85, 90, 95
			]
		}
	];
