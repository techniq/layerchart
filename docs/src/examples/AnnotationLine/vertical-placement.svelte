<script lang="ts">
	...
	import AnnotationLineControls from '$lib/components/AnnotationRangePointLineControls.svelte';
...
<AnnotationLineControls bind:placement bind:xOffset bind:yOffset includeRadius={true} />
