...
<!--
	...
	Full Documentation: [Graticule](/docs/components/Graticule)

	## API Properties

	* lines:<Partial<ComponentProps<typeof GeoPath>> | boolean | undefined> - undefined 
	* outline:<Partial<ComponentProps<typeof GeoPath>> | boolean | undefined> - undefined 
