...
<!--
	...
	Full Documentation: [Tree](/docs/components/Tree)

	## API Properties

	* hierarchy:<HierarchyNode<T>> - d3 hierarchy node  (REQUIRED)
	* nodeSize:<[ number, number ]> - Sets this tree layout’s node size to the specified two-element array of numbers `[width, height]`.
...
see: https://github.com/d3/d3-hierarchy#tree_nodeSize 
	...
	* children:<Snippet<[ { nodes: HierarchyPointNode<any>[]; links: HierarchyPointLink<any>[]; } ]>> - undefined 
