...
<!--
	...
	Full Documentation: [Partition](/docs/components/Partition)
	...
	* padding:<number> - The padding between nodes in the partition layout.
see: https://github.com/d3/d3-hierarchy#tree_nodeSize 
	* round:<boolean> - The round property of the partition layout.
see: https://github.com/d3/d3-hierarchy#tree_nodeSize 
