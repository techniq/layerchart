<script lang="ts">
	...
	import type { GeoTile } from 'layerchart';

	// <ZoomableTileMapControls bind:serviceUrl bind:zoomDelta />

	interface Props {
		serviceUrl?: ComponentProps<typeof GeoTile>['url'];
		zoomDelta?: number;
	}
...
<div class="grid grid-cols-[1fr_1fr] gap-2 my-2 screenshot-hidden">
