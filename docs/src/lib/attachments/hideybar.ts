 ...
 * @param {{ offsetTop?: string, mx?: string, threshold?: number }} [params]
 * @param {string} [params.offsetTop='0px'] - The top offset of the sticky bar
 * @param {string} [params.mx='0px'] - The "margin-inline" around the sticky bar
 * @param {number} [params.threshold=0] - The scroll threshold at which to hide the bar
 */
export function hideybar(node: HTMLElement, { offsetTop = '0px', mx = '0px', threshold = 0 } = {}) {
