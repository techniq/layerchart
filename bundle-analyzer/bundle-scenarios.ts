...
export const scenarios: Scenario[] = [
  ...
  { name: 'Vector', group: 'Components', description: 'Standalone Vector (agnostic) — baseline', imports: ['Vector'] },
  { name: 'Vector.svg', group: 'Components', description: 'Standalone Vector from `layerchart/svg`', imports: ['Vector'], layers: { Vector: 'svg' } },
  { name: 'Vector.canvas', group: 'Components', description: 'Standalone Vector from `layerchart/canvas`', imports: ['Vector'], layers: { Vector: 'canvas' } },
  { name: 'Link', group: 'Components', description: 'Standalone Link (agnostic) — baseline', imports: ['Link'] },
  { name: 'Link.svg', group: 'Components', description: 'Standalone Link from `layerchart/svg`', imports: ['Link'], layers: { Link: 'svg' } },
  { name: 'Link.canvas', group: 'Components', description: 'Standalone Link from `layerchart/canvas`', imports: ['Link'], layers: { Link: 'canvas' } },
  { name: 'AnnotationRange', group: 'Components', description: 'Standalone AnnotationRange (agnostic) — baseline', imports: ['AnnotationRange'] },
  { name: 'AnnotationRange.svg', group: 'Components', description: 'Standalone AnnotationRange from `layerchart/svg`', imports: ['AnnotationRange'], layers: { AnnotationRange: 'svg' } },
  { name: 'AnnotationRange.canvas', group: 'Components', description: 'Standalone AnnotationRange from `layerchart/canvas`', imports: ['AnnotationRange'], layers: { AnnotationRange: 'canvas' } },
  { name: 'Hull', group: 'Components', description: 'Standalone Hull (agnostic) — baseline', imports: ['Hull'] },
  { name: 'Hull.svg', group: 'Components', description: 'Standalone Hull from `layerchart/svg`', imports: ['Hull'], layers: { Hull: 'svg' } },
  { name: 'Hull.canvas', group: 'Components', description: 'Standalone Hull from `layerchart/canvas`', imports: ['Hull'], layers: { Hull: 'canvas' } },
  { name: 'Density', group: 'Components', description: 'Standalone Density (agnostic) — baseline', imports: ['Density'] },
  { name: 'Density.svg', group: 'Components', description: 'Standalone Density from `layerchart/svg`', imports: ['Density'], layers: { Density: 'svg' } },
  { name: 'Density.canvas', group: 'Components', description: 'Standalone Density from `layerchart/canvas`', imports: ['Density'], layers: { Density: 'canvas' } },
  { name: 'Calendar', group: 'Components', description: 'Standalone Calendar (agnostic) — baseline', imports: ['Calendar'] },
  { name: 'Calendar.svg', group: 'Components', description: 'Standalone Calendar from `layerchart/svg`', imports: ['Calendar'], layers: { Calendar: 'svg' } },
  { name: 'Calendar.canvas', group: 'Components', description: 'Standalone Calendar from `layerchart/canvas`', imports: ['Calendar'], layers: { Calendar: 'canvas' } },
  { name: 'CircleClipPath', group: 'Components', description: 'Standalone CircleClipPath (agnostic) — baseline', imports: ['CircleClipPath'] },
  { name: 'CircleClipPath.svg', group: 'Components', description: 'Standalone CircleClipPath from `layerchart/svg`', imports: ['CircleClipPath'], layers: { CircleClipPath: 'svg' } },
  ...
  // Geo components
  { name: 'GeoPath', group: 'Components', description: 'Standalone GeoPath (agnostic) — baseline', imports: ['GeoPath'] },
  { name: 'GeoPath.svg', group: 'Components', description: 'Standalone GeoPath from `layerchart/svg`', imports: ['GeoPath'], layers: { GeoPath: 'svg' } },
  { name: 'GeoPath.canvas', group: 'Components', description: 'Standalone GeoPath from `layerchart/canvas`', imports: ['GeoPath'], layers: { GeoPath: 'canvas' } },
  { name: 'GeoSpline', group: 'Components', description: 'Standalone GeoSpline (agnostic) — baseline', imports: ['GeoSpline'] },
  { name: 'GeoSpline.svg', group: 'Components', description: 'Standalone GeoSpline from `layerchart/svg`', imports: ['GeoSpline'], layers: { GeoSpline: 'svg' } },
  { name: 'GeoSpline.canvas', group: 'Components', description: 'Standalone GeoSpline from `layerchart/canvas`', imports: ['GeoSpline'], layers: { GeoSpline: 'canvas' } },
  { name: 'GeoPoint', group: 'Components', description: 'Standalone GeoPoint (agnostic) — baseline', imports: ['GeoPoint'] },
  { name: 'GeoPoint.svg', group: 'Components', description: 'Standalone GeoPoint from `layerchart/svg`', imports: ['GeoPoint'], layers: { GeoPoint: 'svg' } },
  { name: 'GeoPoint.canvas', group: 'Components', description: 'Standalone GeoPoint from `layerchart/canvas`', imports: ['GeoPoint'], layers: { GeoPoint: 'canvas' } },
  { name: 'GeoCircle', group: 'Components', description: 'Standalone GeoCircle (agnostic) — baseline', imports: ['GeoCircle'] },
  { name: 'GeoCircle.svg', group: 'Components', description: 'Standalone GeoCircle from `layerchart/svg`', imports: ['GeoCircle'], layers: { GeoCircle: 'svg' } },
  { name: 'GeoCircle.canvas', group: 'Components', description: 'Standalone GeoCircle from `layerchart/canvas`', imports: ['GeoCircle'], layers: { GeoCircle: 'canvas' } },
  { name: 'GeoTile', group: 'Components', description: 'Standalone GeoTile (agnostic) — baseline', imports: ['GeoTile'] },
  { name: 'GeoTile.svg', group: 'Components', description: 'Standalone GeoTile from `layerchart/svg`', imports: ['GeoTile'], layers: { GeoTile: 'svg' } },
  { name: 'GeoTile.canvas', group: 'Components', description: 'Standalone GeoTile from `layerchart/canvas`', imports: ['GeoTile'], layers: { GeoTile: 'canvas' } },
  { name: 'TileImage', group: 'Components', description: 'Standalone TileImage (agnostic) — baseline', imports: ['TileImage'] },
  { name: 'TileImage.svg', group: 'Components', description: 'Standalone TileImage from `layerchart/svg`', imports: ['TileImage'], layers: { TileImage: 'svg' } },
  { name: 'TileImage.canvas', group: 'Components', description: 'Standalone TileImage from `layerchart/canvas`', imports: ['TileImage'], layers: { TileImage: 'canvas' } },
  { name: 'Graticule', group: 'Components', description: 'Standalone Graticule (agnostic) — baseline', imports: ['Graticule'] },
  { name: 'Graticule.svg', group: 'Components', description: 'Standalone Graticule from `layerchart/svg`', imports: ['Graticule'], layers: { Graticule: 'svg' } },
  { name: 'Graticule.canvas', group: 'Components', description: 'Standalone Graticule from `layerchart/canvas`', imports: ['Graticule'], layers: { Graticule: 'canvas' } },
  { name: 'GeoClipPath', group: 'Components', description: 'Standalone GeoClipPath (agnostic) — baseline', imports: ['GeoClipPath'] },
  { name: 'GeoClipPath.svg', group: 'Components', description: 'Standalone GeoClipPath from `layerchart/svg`', imports: ['GeoClipPath'], layers: { GeoClipPath: 'svg' } },
  { name: 'GeoClipPath.canvas', group: 'Components', description: 'Standalone GeoClipPath from `layerchart/canvas`', imports: ['GeoClipPath'], layers: { GeoClipPath: 'canvas' } },
  { name: 'GeoEdgeFade', group: 'Components', description: 'Standalone GeoEdgeFade (agnostic) — baseline', imports: ['GeoEdgeFade'] },
  { name: 'GeoEdgeFade.svg', group: 'Components', description: 'Standalone GeoEdgeFade from `layerchart/svg`', imports: ['GeoEdgeFade'], layers: { GeoEdgeFade: 'svg' } },
  { name: 'GeoEdgeFade.canvas', group: 'Components', description: 'Standalone GeoEdgeFade from `layerchart/canvas`', imports: ['GeoEdgeFade'], layers: { GeoEdgeFade: 'canvas' } },
